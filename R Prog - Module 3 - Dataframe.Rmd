---
title: "R Programming Module 3 - Dataframe"
...
```{r}
ggplot(df, aes(ABCresults, CBSresults, color = Names))+geom_point()+geom_text(aes(label = Names),check_overlap = FALSE,hjust = .6, vjust = 1)
```
